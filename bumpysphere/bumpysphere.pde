...
class BumpySphere
{
  ...
  float f(float x, float y, float z)
  {
    switch (surfaceType) {
    case 0:  
      return  0.03 * snoise(x, y, z, 8);
    case 1:  
      return  0.01 * stripes(x + 2*turbulence(x, y, z, 2), 1.6);
    case 2:  
      return -0.10 * turbulence(x, y, z, 1)*.5 * turbulence(x, y, z, 1);      
    default: 
      return -0.10 * turbulence(x, y, z, 2);
    }
  }
